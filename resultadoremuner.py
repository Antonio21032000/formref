...
# Estilo CSS personalizado [mantido o mesmo CSS anterior...]
...
def load_data():
    try:
        ...
        # Garantir que Total_Remuneracao seja numérico
        df['Total_Remuneracao'] = df['Total_Remuneracao'].astype(float)
